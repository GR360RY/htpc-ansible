...
INSERT INTO `path` VALUES (1,'{{ xbmc_media_path }}/{{ xbmc_default_media_folders.movies }}/','movies','metadata.themoviedb.org','fast1399305485',2147483647,0,'<settings><setting id=\"RatingS\" value=\"TMDb\" /><setting id=\"TrailerQ\" value=\"No\" /><setting id=\"certprefix\" value=\"Rated \" /><setting id=\"fanart\" value=\"true\" /><setting id=\"keeporiginaltitle\" value=\"false\" /><setting id=\"language\" value=\"en\" /><setting id=\"tmdbcertcountry\" value=\"us\" /><setting id=\"trailer\" value=\"true\" /></settings>',0,0,NULL),(2,'{{ xbmc_media_path }}/{{ xbmc_default_media_folders.tv }}/','tvshows','metadata.tvdb.com',NULL,0,0,'<settings><setting id=\"absolutenumber\" value=\"false\" /><setting id=\"dvdorder\" value=\"false\" /><setting id=\"fanart\" value=\"true\" /><setting id=\"language\" value=\"en\" /></settings>',0,0,NULL);
